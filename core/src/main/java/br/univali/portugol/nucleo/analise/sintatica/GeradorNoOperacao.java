 ...
 * @author Elieser
 */
class GeradorNoOperacao<TipoEscopo extends ParserRuleContext, TipoRetorno extends NoBloco> {

    private final Class<TipoRetorno> clazz;

    public GeradorNoOperacao(Class<TipoRetorno> clazz) {
        this.clazz = clazz;
    }

    public TipoRetorno gera(TipoEscopo ctx, PortugolBaseVisitor visitor) {
        try {
