...
public class HackWebTabbedPaneUI extends BasicTabbedPaneUI implements ShapeProvider, BorderMethods
{
    ...
    //PARAMETROS QUE FORAM ALTERADOS PARA O PORTUGOL STUDIO
    
    private Color tabBorderColor = StyleConstants.darkBorderColor;// Utils.COR_DAS_BORDAS_DOS_PAINEIS_TABULADOS;// WebTabbedPaneStyle.tabBorderColor;
    private Color contentBorderColor = tabBorderColor;// WebTabbedPaneStyle.contentBorderColor;
    private boolean paintBorderOnlyOnSelectedTab = false;// WebTabbedPaneStyle.paintBorderOnlyOnSelectedTab;
    private boolean forceUseSelectedTabBgColors = false;// WebTabbedPaneStyle.forceUseSelectedTabBgColors;
    private Color backgroundColor = StyleConstants.backgroundColor;// WebTabbedPaneStyle.backgroundColor;
    private boolean paintOnlyTopBorder = true;// WebTabbedPaneStyle.paintOnlyTopBorder;
    ...
    public HackWebTabbedPaneUI() {
        super();
        tabbedPaneStyle = TabbedPaneStyle.attached;
        round = 5; 
    }
    ...
    {
        return new HackWebTabbedPaneUI ();
    }
