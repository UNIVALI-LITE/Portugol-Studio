...
public class IconFactory {
    ...
    public static final String CAMINHO_ICONES_PEQUENOS = "br/univali/ps/ui/icones/Dark/pequeno";
    public static final String CAMINHO_ICONES_GRANDES = "br/univali/ps/ui/icones/Dark/grande";
