 ...
 */
public final class AbaAjudaOld extends Aba
{
    ...
    private void configurarWebEngine()
    {
        ...
        {
            Logger.getLogger(AbaAjudaOld.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
            ...
            public void handle(final WebEvent<String> evento)
            {
                try
                {
                    SwingUtilities.invokeAndWait(new Runnable()
                    {
                        ...
                        public void run()
                        {
                            JOptionPane.showMessageDialog(AbaAjudaOld.this, evento.getData(), "Portugol Studio", JOptionPane.INFORMATION_MESSAGE);
                        }
                    });
                }
    ...
    private void exibirPainelCarregamento()
    {
        SwingUtilities.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                ...
                layout.show(AbaAjudaOld.this, "painelCarregamento");
            }
        });
    }
    ...
    private void exibirAjuda()
    {
        SwingUtilities.invokeLater(new Runnable()
        {
            ...
            {
                CardLayout layout = (CardLayout) getLayout();
                layout.show(AbaAjudaOld.this, "painelConteudo");
