...
public class RstaIconFactory {
	...
	public Icon getIcon(String key, boolean deprecated) {
		...
		if (deprecated) { // TODO: Optimize me
			RstaDecoratableIcon di = new RstaDecoratableIcon(16, icon);
	...
	public Icon getIcon(IconData data) {
		// TODO: Optimize me
		RstaDecoratableIcon icon = new RstaDecoratableIcon(16, getIcon(data.getIcon()));
