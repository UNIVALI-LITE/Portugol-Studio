// O exemplo pede três valores reias, que representam a altura de três pessoas ,e ao fim exibe a media da altura.
programa
{
	funcao inicio()
	{
		...
		escreva("A média da altura das três pessoas é:  ", mediaAltura," m") // exibe o resultado final
	}
}
